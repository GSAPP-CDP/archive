...
year: 2026
image: /img/2026/AWeatheringStation/viewcapture3.png
links:
...
Fog as a weighted socio-cultural tool.
  Fog holds significant perceptual weight when it is present. I attempt to harness that perception through movement and material actuation. 
...
By turning these ephemeral movements into markings to then be made into static molds, I am pointing to the tension of turning fog moisture into a system of both a cultural artifact and evolving boundary condition. 

Making fog reading into a static form is almost non-sensical, but there is a need to let it speak through archival material, beyond numbers but via spatialized drawings that can be re-posted and serve as a spatial dialogue with the immediate atmospheric patterns of the raw data generation on the scrolls. 

## *For Future Projections*

If air pressure were to drop and fog dissipation were to increase, how would this device need to operate?
...
[^1]: Jennifer Gabrys, "Becoming Planetary," *E-flux Architecture: Accumulation* (October 2018). [https://www.e-flux.com/architecture/accumulation/217051/becoming-planetary](https://www.e-flux.com/architecture/accumulation/217051/becoming-planetary)

[^2]: John Durham Peters, *The Marvelous Clouds: Toward a Philosophy of Elemental Media* (University of Chicago Press, 2015).

[^3]: Eva Horn, "Air as Medium," *Grey Room* 73 (2018): 6–25. [https://doi.org/10.1162/grey_a_00254](https://doi.org/10.1162/grey_a_00254)

[^4]: Joanna Zylinska, "On Life, Movement and Stoppage: Agency and Ethics in the Anthropocene," *Leonardo* 48, no. 3 (April 2015).

[^5]: Yuriko Furuhata, "Of Dragons and Geoengineering: Rethinking Elemental Media," *Media+Environment* 1, no. 1 (2019). [https://doi.org/10.1525/001c.10797](https://doi.org/10.1525/001c.10797)

[^6]: Mark Wigley, "Chronic Whiteness," *Sick Architecture*, e-flux Architecture. [https://www.e-flux.com/architecture/sick-architecture/360099/chronic-whiteness](https://www.e-flux.com/architecture/sick-architecture/360099/chronic-whiteness)
